...
class CreateGradeUserTable extends Migration
{
    public function up()
    {
        Schema::create('grade_user', function (Blueprint $table) {
            ...
            $table->foreign('teacher_id', 'teacher_id_fk_1001499')->references('id')->on('users')->onDelete('cascade');
            $table->unsignedInteger('lesson_id');
            $table->foreign('lesson_id', 'lesson_id_fk_1001499')->references('id')->on('lessons')->onDelete('cascade');
