		...
		public function run() {
			$permissions = [
				[
					...
					'id' => '27', 'title' => 'lesson_grade_show',
				], [
					'id' => '28', 'title' => 'lesson_grade_delete',
				], [
					'id' => '29', 'title' => 'lesson_grade_create',
				], [
					'id' => '30', 'title' => 'lesson_grade_edit',
				], [
					'id' => '31', 'title' => 'lesson_grade_access',
				],
			];
